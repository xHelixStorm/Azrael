...
public class Inventory implements Command{
	...
	public void action(String[] args, MessageReceivedEvent e) {
		if(GuildIni.getHelpCommand(e.getGuild().getIdLong())){
			...
			if(UserPrivs.comparePrivilege(e.getMember(), GuildIni.getInventoryLevel(e.getGuild().getIdLong())) || GuildIni.getAdmin(e.getGuild().getIdLong()) == e.getMember().getUser().getIdLong()) {
