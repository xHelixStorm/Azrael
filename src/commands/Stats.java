...
public class Stats implements CommandPublic {
	...
	public boolean called(String[] args, GuildMessageReceivedEvent e) {
		...
		if(GuildIni.getStatsCommand(e.getGuild().getIdLong())) {
			final var commandLevel = GuildIni.getStatsLevel(e.getGuild().getIdLong());
	...
	public void executed(boolean success, GuildMessageReceivedEvent e) {
		logger.debug("{} has used Stats command in guild {}", e.getMember().getUser().getId(), e.getGuild().getId());
	}
