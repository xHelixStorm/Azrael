...
public class Hashes {
    ...
    private static final Map<Long, Long> message_removed = new HashMap<Long, Long>();
	...
	public static void addMessageRemoved(Long _key, Long _message_id){
		message_removed.put(_key, _message_id);
	}
	...
	public static Long getMessageRemoved(Long _key){
