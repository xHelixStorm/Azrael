...
public class Twitch implements CommandPublic {
	...
	public boolean called(String[] args, GuildMessageReceivedEvent e) {
		...
		if(GuildIni.getTwitchCommand(e.getGuild().getIdLong())) {
			final var commandLevel = GuildIni.getTwitchLevel(e.getGuild().getIdLong());
	...
	public void executed(boolean success, GuildMessageReceivedEvent e) {
		logger.trace("{} has used Twitch command in guild {}", e.getMember().getUser().getIdLong(), e.getGuild().getId());
	}
