...
public class UserExecution {
	...
	public static void getHelp(MessageReceivedEvent e) {
		...
		e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_HELP)).build()).queue();
	}
	
	public static void runTask(MessageReceivedEvent e, String input, BotConfigs botConfig) {
		...
		if(user != null && !user.isDefault()) {
			...
			if(out.length() > 0) {
				...
				e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DISABLED).replace("{}", user.getUserName())).build()).queue();
			}
		}
		else if(user != null) {
			e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_NOT_FOUND)).build()).queue();
		}
		else {
	...
	public static void performAction(MessageReceivedEvent e, String _message, Cache cache, ArrayList<Channels> _allChannels, BotConfigs botConfig) {
		var key = "user_gu"+e.getGuild().getId()+"ch"+e.getChannel().getId()+"us"+e.getMember().getUser().getId();
		if(cache != null && cache.getExpiration() - System.currentTimeMillis() > 0) {
			...
			if(comment.equals("exit")) {
				e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_EXIT)).build()).queue();
			...
			if(!cache.getAdditionalInfo().matches("[a-zA-Z\\-]{1,}[\\d]*")) {
				if(comment.equals(STATIC.getTranslation(e.getMember(), Translation.PARAM_INFORMATION)) && STATIC.getCommandEnabled(e.getGuild(), Command.USER_INFORMATION)) {
					...
					if(UserPrivs.comparePrivilege(e.getMember(), informationLevel)) {
						...
						if(user != null) {
							...
							if(out.length() > 0) {
								...
								e.getChannel().sendMessageEmbeds(message.build()).queue(m -> {
							...
							if(System.getProperty("ACTION_LOG").equals("true")) {
								...
								if(out.length() > 0) {
									...
									e.getChannel().sendMessageEmbeds(message.setDescription(out.toString()).build()).queue(m -> {
							...
							e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_INFO_ERR)).build()).queue();
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.MESSAGE_MANAGE)) {
						if(e.getGuild().getSelfMember().hasPermission(Permission.MESSAGE_HISTORY)) {
							...
							if(UserPrivs.comparePrivilege(e.getMember(), deleteMessagesLevel)) {
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_HELP)).build()).queue();
							...
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.MESSAGE_HISTORY.getName()).build()).queue();
						...
						message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setColor(Color.RED);
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.MESSAGE_MANAGE.getName()).build()).queue();
					...
					if(UserPrivs.comparePrivilege(e.getMember(), warningLevel)) {
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WARNING_HELP)).build()).queue();
					...
					if(member == null)
						e.getChannel().sendMessageEmbeds(message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_WARNING)).setColor(Color.ORANGE).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_LEFT)).build()).queue();
					if(member != null && !e.getGuild().getSelfMember().canInteract(e.getGuild().getMemberById(user_id))) {
						...
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_HIGHER_PERMISSION)).build()).queue();
						Hashes.clearTempCache(key);
						return;
					}
					...
					if(!UserPrivs.isUserMuted(member)) {
						if(e.getGuild().getSelfMember().hasPermission(Permission.MANAGE_ROLES)) {
							...
							if(UserPrivs.comparePrivilege(e.getMember(), muteLevel)) {
								message.setColor(Color.BLUE);
								if(botConfig.getForceReason()) {
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REASON)).build()).queue();
									...
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REASON_QUESTION)).build()).queue();
							...
							message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setColor(Color.RED);
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.MANAGE_ROLES.getName()).build()).queue();
						...
						message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_ALREADY_MUTED)
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.MANAGE_ROLES)) {
						...
						if(UserPrivs.comparePrivilege(e.getMember(), unmuteLevel)) {
							if(!Azrael.SQLisBanned(user_id, e.getGuild().getIdLong())) {
								if(Azrael.SQLgetCustomMuted(user_id, e.getGuild().getIdLong())) {
									...
									if(STATIC.killThread("mute_gu"+e.getGuild().getId()+"us"+user_id)) {
										e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNMUTE_RUN)).build()).queue();
									}
									else {
										message.setColor(Color.RED).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR));
										e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNMUTE_NOT_MUTED)).build()).queue();
									}
								}
									...
									Hashes.addTempCache("unmute_gu"+e.getGuild().getId()+"us"+user_id, new Cache(60000, ""+e.getMember().getUser().getId()));
									if(STATIC.killThread("mute_gu"+e.getGuild().getId()+"us"+user_id)) {
										e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNMUTE_RUN_2)).build()).queue();
								...
								e.getChannel().sendMessageEmbeds(error.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNMUTE_IS_BANNED)).build()).queue();
							}
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.BAN_MEMBERS)) {
						...
						if(UserPrivs.comparePrivilege(e.getMember(), banLevel)) {
							message.setColor(Color.BLUE);
							if(botConfig.getForceReason()) {
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REASON)).build()).queue();
						...
						message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setColor(Color.RED);
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.BAN_MEMBERS.getName()).build()).queue();
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.BAN_MEMBERS)) {
						...
						if(UserPrivs.comparePrivilege(e.getMember(), unbanLevel)) {
							e.getGuild().retrieveBan(net.dv8tion.jda.api.entities.User.fromId(user_id)).queue(success -> {
								if(botConfig.getForceReason()) {
									e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REASON)).build()).queue();
									...
									e.getChannel().sendMessageEmbeds(embed.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REASON_QUESTION)).build()).queue();
								...
								e.getChannel().sendMessageEmbeds(embed.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNBAN_NOT_BANNED)).build()).queue();
								Hashes.clearTempCache(key);
							});
							Azrael.SQLInsertCommandLog(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), Command.USER.getColumn(), _message);
						}
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.KICK_MEMBERS)) {
						...
						if(UserPrivs.comparePrivilege(e.getMember(), kickLevel)) {
							message.setColor(Color.BLUE);
							if(botConfig.getForceReason()) {
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REASON)).build()).queue();
						...
						message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setColor(Color.RED);
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.KICK_MEMBERS.getName()).build()).queue();
					...
					if(UserPrivs.comparePrivilege(e.getMember(), assignRoleLevel)) {
						int count = 0;
						...
						if(roles.size() > 0) {
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_ASSIGN_HELP)+out.toString()).build()).queue();
							cache.updateDescription("assign-role"+user_id).setExpiration(180000).setObject(roles);
							Hashes.addTempCache(key, cache);
						}
						else {
							message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_ASSIGN_NO_ROLES)).build()).queue();
							Hashes.clearTempCache(key);
						}
						Azrael.SQLInsertCommandLog(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), Command.USER.getColumn(), _message);
					}
					...
					if(UserPrivs.comparePrivilege(e.getMember(), removeRoleLevel)) {
						int count = 0;
						ArrayList<Long> roles = new ArrayList<Long>();
						StringBuilder out = new StringBuilder();
						for(final var role : e.getGuild().getRoles()) {
						...
						if(roles.size() > 0) {
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REMOVE_HELP)+out.toString()).build()).queue();
							cache.updateDescription("remove-role"+user_id).setExpiration(180000).setObject(roles);
							Hashes.addTempCache(key, cache);
						}
						else {
							message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REMOVE_NO_ROLES)).build()).queue();
							Hashes.clearTempCache(key);
						}
						Azrael.SQLInsertCommandLog(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), Command.USER.getColumn(), _message);
					}
					...
					if(UserPrivs.comparePrivilege(e.getMember(), historyLevel)) {
						StringBuilder out = new StringBuilder();
						...
						if(out.length() > 0) {
							e.getChannel().sendMessageEmbeds(message.setTitle(STATIC.getTranslation(e.getMember(), Translation.USER_HISTORY_DISPLAY)).setDescription((out.length() <= 2048 ? out.toString() : out.toString().substring(0, 2040)+"...")).build()).queue();
						}
						else
							e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setTitle(STATIC.getTranslation(e.getMember(), Translation.USER_HISTORY_TITLE_EMPTY)).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_HISTORY_EMPTY)).build()).queue();
						Hashes.clearTempCache(key);
						Azrael.SQLInsertCommandLog(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), Command.USER.getColumn(), _message);
					}
					else {
					...
					if(UserPrivs.comparePrivilege(e.getMember(), watchLevel)) {
						if(!botConfig.getCacheLog()) {
							e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.ORANGE).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_WARNING)).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WATCH_CACHE)).build()).queue();
						}
						message.setColor(Color.BLUE);
					...
					if(UserPrivs.comparePrivilege(e.getMember(), unwatchLevel)) {
						...
						if(watchedMember != null) {
							if(!watchedMember.hasHigherPrivileges()) {
								...
								if(Azrael.SQLDeleteWatchlist(user_id, e.getGuild().getIdLong()) > 0) {
									...
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNWATCH)).build()).queue();
									logger.info("User {} has removed the user {} from the watchlist in guild {}", e.getMember().getUser().getId(), user_id, e.getGuild().getId());
								}
								else {
									//Error DB update
									message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.GENERAL_ERROR)).build());
								...
								message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNWATCH_NOT_WATCHED)).build()).queue();
							}
						}
						else {
							//error: the user isn't being watched
					...
					if(UserPrivs.comparePrivilege(e.getMember(), giftExperienceLevel)) {
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_GIFT_EXP)).build()).queue();
					...
					if(UserPrivs.comparePrivilege(e.getMember(), setExperienceLevel)) {
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_SET_EXP)).build()).queue();
					...
					if(UserPrivs.comparePrivilege(e.getMember(), setLevelLevel)) {
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_LEVEL)).build()).queue();
					...
					if(UserPrivs.comparePrivilege(e.getMember(), giftCurrencyLevel)) {
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_GIFT_CUR)).build()).queue();
					...
					if(UserPrivs.comparePrivilege(e.getMember(), setCurrencyLevel)) {
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_SET_CUR)).build()).queue();
				...
				if(_message.equalsIgnoreCase(STATIC.getTranslation(e.getMember(), Translation.PARAM_YES))) {
					if(cache.getAdditionalInfo3().length() == 0) {
						...
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_DELETING)).build()).queue();
					...
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_ABORT)).build()).queue();
					Hashes.clearTempCache(key);
						...
						if(db_warning != 0) {
							...
							if(warning_id == 0) {
								if(Azrael.SQLDeleteData(user_id, e.getGuild().getIdLong()) > 0) {
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WARNING_CLEAR)).build()).queue();
								...
								if(Azrael.SQLUpdateWarning(user_id, e.getGuild().getIdLong(), warning_id) > 0) {
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WARNING_UPDATED)).build()).queue();
								...
								if(Azrael.SQLUpdateWarning(user_id, e.getGuild().getIdLong(), max_warning_id) > 0) {
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WARNING_UPDATED_LIMIT)).build()).queue();
							...
							if(UserPrivs.comparePrivilege(e.getMember(), STATIC.getCommandLevel(e.getGuild(), Command.USER_WARNING_FORCE))) {
								int warning_id = Integer.parseInt(_message.replaceAll("[^0-9]*", ""));
								int max_warning_id = Azrael.SQLgetMaxWarning(e.getGuild().getIdLong());
								...
								e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WARNING_NEVER_WARNED)).build()).queue();
							}
						}
					}
					else {
						e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WARNING_IS_MUTED)).build()).queue();
					}
					Hashes.clearTempCache(key);
				...
				if(comment.equals(STATIC.getTranslation(e.getMember(), Translation.PARAM_YES))) {
					...
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_CHOICE)).build()).queue();
				...
				if(comment.equals(STATIC.getTranslation(e.getMember(), Translation.PARAM_YES))) {
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_FORMAT)).build()).queue();
					...
					Member member = e.getGuild().getMemberById(user_id);
					if(member == null) {
						e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_LEFT)).addField(STATIC.getTranslation(e.getMember(), Translation.USER_REASON_YES), "", true).addField(STATIC.getTranslation(e.getMember(), Translation.USER_REASON_NO), "", true).build()).queue();
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.MANAGE_ROLES)) {
						...
						if(mute_role_id != null) {
							...
							e.getChannel().sendMessageEmbeds(message.setDescription((permMute ? STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_ORDER_2) : STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_ORDER_1))).build()).queue();
							checkIfDeleteMessagesAfterAction(e, cache, user_id, _message, message, key, botConfig);
						}
						else {
							e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.NO_MUTE_ROLE)).build()).queue();
							Hashes.clearTempCache(key);
						}
					}
					else {
				...
				if(_message.replaceAll("[0-9]*", "").length() == 1 && (comment.endsWith("m") || comment.endsWith("h") || comment.endsWith("d"))) {
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.MANAGE_ROLES)) {
						...
						if(mute_role_id != null) {
							...
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_ORDER_1)).build()).queue();
							logger.info("User {} has muted user {} in guild {}", e.getMember().getUser().getId(), user_id, e.getGuild().getId());
							checkIfDeleteMessagesAfterAction(e, cache, user_id, _message, message, key, botConfig);
						}
						else {
							e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.NO_MUTE_ROLE)).build()).queue();
							Hashes.clearTempCache(key);
						}
					}
					else {
					...
					e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_MUTE_NUMERIC)).build()).queue();
				}
			}
			else if(cache.getAdditionalInfo().replaceAll("[0-9]*", "").equals("mute-delay")) {
				if(_message.equalsIgnoreCase(STATIC.getTranslation(e.getMember(), Translation.PARAM_YES))) {
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REMINDER_SET)).build()).queue();
					...
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REMINDER_NOT_SET)).build()).queue();
					Hashes.clearTempCache(key);
					Azrael.SQLInsertCommandLog(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), Command.USER_MUTE.getColumn(), _message);
				}
			}
				...
				if(comment.equals(STATIC.getTranslation(e.getMember(), Translation.PARAM_YES))) {
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.BAN_MEMBERS)) {
						if(member != null) {
								...
								if(warning_id == max_warning_id) {
									channel.sendMessage(STATIC.getTranslation2(e.getGuild(), Translation.USER_BAN_DM).replace("{}", e.getGuild().getName())
										+ (botConfig.getBanSendReason() ? STATIC.getTranslation2(e.getGuild(), Translation.USER_BAN_REASON)+reason : "")).queue(m -> {
											e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setDescription(STATIC.getTranslation2(e.getGuild(), Translation.USER_BAN_ORDER)).build()).queue();
											e.getGuild().ban(e.getGuild().getMemberById(user_id), 0, TimeUnit.SECONDS).reason(reason).queue();
										}, err -> {
											e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setDescription(STATIC.getTranslation2(e.getGuild(), Translation.USER_BAN_ORDER)).build()).queue();
											e.getGuild().ban(e.getGuild().getMemberById(user_id), 0, TimeUnit.SECONDS).reason(reason).queue();
										});
							...
							e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_BAN_LEFT)).addField(STATIC.getTranslation(e.getMember(), Translation.USER_REASON_YES), "", true).addField(STATIC.getTranslation(e.getMember(), Translation.USER_REASON_NO), "", true).build()).queue();
				...
				if(e.getGuild().getSelfMember().hasPermission(Permission.BAN_MEMBERS)) {
							...
							if(warning_id == max_warning_id) {
								channel.sendMessage(STATIC.getTranslation2(e.getGuild(), Translation.USER_BAN_DM).replace("{}", e.getGuild().getName())
									+ (botConfig.getBanSendReason() ? STATIC.getTranslation2(e.getGuild(), Translation.USER_BAN_REASON)+_message : "")).queue(m -> {
										e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_BAN_ORDER)).build()).queue();
										e.getGuild().ban(e.getGuild().getMemberById(user_id), 0, TimeUnit.SECONDS).reason(_message).queue();
									}, err -> {
										e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_BAN_ORDER)).build()).queue();
										e.getGuild().ban(e.getGuild().getMemberById(user_id), 0, TimeUnit.SECONDS).reason(_message).queue();
									});
					...
					message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setColor(Color.RED);
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.BAN_MEMBERS).build()).queue();
					logger.warn("BAN MEMBERS permission required to ban a user in guild {}", e.getGuild().getId());
					Hashes.clearTempCache(key);
				}
				Azrael.SQLInsertCommandLog(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), Command.USER_BAN.getColumn(), _message);
				...
				if(comment.equals(STATIC.getTranslation(e.getMember(), Translation.PARAM_YES))) {
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.BAN_MEMBERS)) {
						...
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNBAN_ORDER)).build()).queue();
						e.getGuild().unban(net.dv8tion.jda.api.entities.User.fromId(user_id)).reason(reason).queue();
				...
				if(e.getGuild().getSelfMember().hasPermission(Permission.BAN_MEMBERS)) {
					...
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_UNBAN_ORDER)).build()).queue();
					e.getGuild().unban(net.dv8tion.jda.api.entities.User.fromId(user_id)).reason(_message).queue();
				...
				if(comment.equals(STATIC.getTranslation(e.getMember(), Translation.PARAM_YES))) {
					...
					if(e.getGuild().getSelfMember().hasPermission(Permission.KICK_MEMBERS)) {
						if(member != null) {
							final String reason = STATIC.getTranslation2(e.getGuild(), Translation.DEFAULT_REASON);
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_KICK_ORDER)).build()).queue();
							...
							member.getUser().openPrivateChannel().queue(channel -> {
								channel.sendMessage(STATIC.getTranslation2(e.getGuild(), Translation.USER_KICK_DM)
									+ (botConfig.getKickSendReason() ? STATIC.getTranslation2(e.getGuild(), Translation.USER_BAN_REASON)+reason : "")).queue(m -> {
										...
										e.getGuild().kick(member).reason(reason).queue();
										e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.ORANGE).setDescription(STATIC.getTranslation2(e.getGuild(), Translation.KICK_DM_LOCKED).replaceFirst("\\{\\}", member.getUser().getName()+"#"+member.getUser().getDiscriminator()).replace("{}", member.getUser().getId())).build()).queue();
									});
							});
							...
							e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_KICK_LEFT)).build()).queue();
							Hashes.clearTempCache(key);
						}
					}
					else {
				...
				if(e.getGuild().getSelfMember().hasPermission(Permission.KICK_MEMBERS)) {
					...
					message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setColor(Color.RED);
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.KICK_MEMBERS).build()).queue();
					logger.warn("KICK MEMBERS permission required to kick a user in guild {}", e.getGuild().getId());
					Hashes.clearTempCache(key);
				}
				Azrael.SQLInsertCommandLog(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), Command.USER_KICK.getColumn(), _message);
					...
					if(roles.size() >= number) {
						...
						if(member != null) {
							if(member.getRoles().parallelStream().filter(f -> f.getIdLong() == role_id).findAny().orElse(null) == null) {
								...
								message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_ASSIGN_ALREADY)).build()).queue();
								Hashes.clearTempCache(key);
							}
						}
						else {
							message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_LEFT)).build()).queue();
							Hashes.clearTempCache(key);
						}
					}
					else {
						message.setColor(Color.RED);
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_NUMBER)).build()).queue();
					...
					if(roles.size() >= number) {
						...
						if(member != null) {
							if(member.getRoles().parallelStream().filter(f -> f.getIdLong() == role_id).findAny().orElse(null) != null) {
								...
								message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setColor(Color.RED);
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_REMOVE_ALREADY)).build()).queue();
								Hashes.clearTempCache(key);
							}
						}
						else {
				...
				if(UserPrivs.comparePrivilege(e.getMember(), STATIC.getCommandLevel(e.getGuild(), Command.USER_USE_WATCH_CHANNEL))) {
					...
					if(trash_channel != null || watch_channel != null) {
						...
						e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_WATCH_ADDED)+_message).build()).queue();
						Hashes.clearTempCache(key);
					}
					else {
						//throw error if no trash or watch channel has been registered
						e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR)).setDescription(STATIC.getTranslation(e.getMember(), Translation.NO_TRA_CHANNEL)).build()).queue();
						Hashes.clearTempCache(key);
					}
				}
				else {
					...
					if(RankingSystem.SQLsetLevelUp(user_details.getUser_ID(), e.getGuild().getIdLong(), user_details.getLevel(), user_details.getExperience(), user_details.getCurrency(), user_details.getCurrentRole(), user_details.getLastUpdate()) > 0) {
						...
						if(roles.size() > 0) {
							if(e.getGuild().getSelfMember().hasPermission(Permission.MANAGE_ROLES)) {
								...
								e.getChannel().sendMessageEmbeds(message.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.MANAGE_ROLES.getName()).build()).queue();
								logger.warn("MANAGE ROLES permission required to assign a ranking role in guild {}", e.getGuild().getId());
							}
						}
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_GIFT_EXP_ADDED)).build()).queue();
				...
				if(_message.replaceAll("[0-9]*", "").length() == 0) {
					...
					if(RankingSystem.SQLsetLevelUp(user_details.getUser_ID(), e.getGuild().getIdLong(), user_details.getLevel(), user_details.getExperience(), user_details.getCurrency(), user_details.getCurrentRole(), user_details.getLastUpdate()) > 0) {
						...
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_SET_EXP_UPDATED)).build()).queue();
				...
				if(_message.replaceAll("[0-9]*", "").length() == 0) {
					...
					if(level <= guild_settings.getMaxLevel()) {
						...
						if(RankingSystem.SQLsetLevelUp(user_details.getUser_ID(), e.getGuild().getIdLong(), user_details.getLevel(), user_details.getExperience(), user_details.getCurrency(), user_details.getCurrentRole(), user_details.getLastUpdate()) > 0) {
							...
							e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_LEVEL_UPDATED)).build()).queue();
						...
						e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_LEVEL_ERR).replace("{}", ""+guild_settings.getMaxLevel())).build()).queue();
					}
				...
				if(_message.replaceAll("[0-9]*", "").length() == 0) {
					...
					if(RankingSystem.SQLUpdateCurrency(user_details.getUser_ID(), e.getGuild().getIdLong(), user_details.getCurrency(), user_details.getLastUpdate()) > 0) {
						...
						Hashes.addRanking(e.getGuild().getIdLong(), user_details.getUser_ID(), user_details);
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_GIFT_CUR_ADDED)).build()).queue();
				...
				if(_message.replaceAll("[0-9]*", "").length() == 0) {
					...
					if(RankingSystem.SQLUpdateCurrency(user_details.getUser_ID(), e.getGuild().getIdLong(), user_details.getCurrency(), user_details.getLastUpdate()) > 0) {
						...
						Hashes.addRanking(e.getGuild().getIdLong(), user_details.getUser_ID(), user_details);
						e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_SET_CUR_UPDATED)).build()).queue();
	...
	private static void checkIfDeleteMessagesAfterAction(MessageReceivedEvent e, Cache cache, long user_id, String _message, EmbedBuilder message, String key, BotConfigs botConfig) {
		if(!botConfig.isMuteMessageDeleteEnabled())
			...
			if(botConfig.getMuteForceMessageDeletion()) {
				if(removeMessages > 0) {
					...
					e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_HELP)).build()).queueAfter(1, TimeUnit.SECONDS);
					cache.updateDescription("delete-messages"+user_id).setExpiration(180000);
					Hashes.addTempCache(key, cache);
				}
			}
				...
				Hashes.addTempCache(key, cache);
				e.getChannel().sendMessageEmbeds(message.build()).queueAfter(1, TimeUnit.SECONDS);
			}
		}
	}
	
	private static void deleteMessages(MessageReceivedEvent e, long user_id, String _message, int messagesCount, EmbedBuilder message, String key, boolean passValue, BotConfigs botConfig) {
				...
				if(messages.size() > 0) {
					if(e.getGuild().getSelfMember().hasPermission(Permission.MESSAGE_MANAGE)) {
						...
						for(int i = messages.size()-1; i >= 0; i--) {
							...
							if(channel != null) {
								if(e.getGuild().getSelfMember().hasPermission(channel, Permission.VIEW_CHANNEL, Permission.MESSAGE_MANAGE, Permission.MESSAGE_HISTORY) || STATIC.setPermissions(e.getGuild(), channel, EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_MANAGE, Permission.MESSAGE_HISTORY))) {
									...
									if(channelErr.contains(currentMessage.getChannelID())) {
										...
										e.getChannel().sendMessageEmbeds(error.setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION_IN).replace("{}", Permission.MESSAGE_MANAGE+" and "+Permission.MESSAGE_HISTORY.getName())+channel.getAsMention()).build()).queue();
						...
						if(collected_messages.length() > 0) {
							...
							if(nextNumber > 0) {
								...
								if(FileHandler.createFile(Directory.TEMP, fileName+fileAppendix, content) && FileHandler.createFile(Directory.USER_LOG, fileName+fileAppendix, content)) {
									e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_REMOVED)+fileName).build()).queue();
									if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.MESSAGE_ATTACH_FILES) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.MESSAGE_ATTACH_FILES))) {
										e.getChannel().sendFiles(FileUpload.fromData(new File(Directory.TEMP.getPath()+fileName+fileAppendix), fileName+fileAppendix)).queue(m -> {
											FileHandler.deleteFile(Directory.TEMP, fileName+fileAppendix);
										});
									}
									else {
										e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.ORANGE).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_WARNING)).setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_ERR_2).replace("{}", Permission.MESSAGE_ATTACH_FILES.getName())).build()).queue();
									...
									e.getChannel().sendMessageEmbeds(error.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_ERR)).build()).queue();
								}
							}
							else {
								error.setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_ERROR));
							...
							if(botConfig.getCacheLog())
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_NOTHING)).build()).queue();
							else
								e.getChannel().sendMessageEmbeds(message.setDescription(STATIC.getTranslation(e.getMember(), Translation.USER_DELETE_NOTHING_2)).build()).queue();
						}
					}
					else {
						e.getChannel().sendMessageEmbeds(message.setColor(Color.RED).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.MESSAGE_MANAGE.getName()).build()).queue();
