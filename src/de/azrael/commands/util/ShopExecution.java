...
public class ShopExecution {
	...
	public static void displayShop(MessageReceivedEvent e, String _type, String _description) {
	...
	public static void displaySingleItem(MessageReceivedEvent e, String _type, String [] _items, Guilds guild_settings, final int selection) {
		if(selection >= 0 && selection < _items.length) {
			...
			e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setDescription(STATIC.getTranslation(e.getMember(), Translation.SHOP_INSPECT_ERR)).build()).queue();
	...
	public static void displayWeaponCategories(MessageReceivedEvent e) {
		...
		if(categoriesList != null) {
			if(categoriesList.size() > 0) {
				...
				e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setThumbnail(BotConfiguration.SQLgetThumbnails(e.getGuild().getIdLong()).getShop()).setDescription(STATIC.getTranslation(e.getMember(), Translation.SHOP_DISPLAY_WEP)+builder.toString()).build()).queue();
	...
	public static void displayShopWeapons(MessageReceivedEvent e, String _type) {
		Guilds guild_settings = RankingSystem.SQLgetGuild(e.getGuild().getIdLong());
	...
	public static void displaySingleWeapon(MessageReceivedEvent e, String _type, String [] weapons, Guilds guild_settings, final int selection) {
	...
	public static void displaySkills(MessageReceivedEvent e, Guilds guild_settings) {
		EmbedBuilder message = new EmbedBuilder().setColor(Color.BLUE).setThumbnail(BotConfiguration.SQLgetThumbnails(e.getGuild().getIdLong()).getShop());
	...
	public static void displaySingleSkill(MessageReceivedEvent e, Guilds guild_settings, String [] skills, final int selection) {
