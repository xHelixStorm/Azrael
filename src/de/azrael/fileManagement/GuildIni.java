...
public class GuildIni {
	...
	public static boolean getPruneCommand(long guild_id) {
		Ini ini = readIni(guild_id);
		return ini.get("Commands", "Prune", boolean.class);
	}
	...
	public static boolean getRedditCommand(long guild_id) {
		Ini ini = readIni(guild_id);
		return ini.get("Commands", "Reddit", boolean.class);
	}
