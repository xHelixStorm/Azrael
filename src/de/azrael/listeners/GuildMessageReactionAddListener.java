...
public class GuildMessageReactionAddListener extends ListenerAdapter {
			...
			new Thread(() ->  {
				...
				if(!e.getUser().isBot() && !e.getGuild().getSelfMember().equals(e.getMember())) {
					...
					if(cache != null && cache.getExpiration() - System.currentTimeMillis() > 0) {
						...
						if(e.getGuild().getSelfMember().hasPermission(textChannel, Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_EMBED_LINKS, Permission.MESSAGE_HISTORY) || STATIC.setPermissions(e.getGuild(), textChannel, EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_EMBED_LINKS, Permission.MESSAGE_HISTORY))) {
							if(e.getGuild().getSelfMember().hasPermission(textChannel, Permission.MESSAGE_ADD_REACTION) || STATIC.setPermissions(e.getGuild(), textChannel, EnumSet.of(Permission.MESSAGE_ADD_REACTION))) {
								textChannel.retrieveMessageById(message_id).queue(message -> {
									...
									Hashes.addTempCache("write_edit_gu"+e.getGuild().getId()+"ch"+e.getChannel().getId()+"us"+e.getMember().getUser().getId(), new Cache(180000, "RA1", message_id, reaction.getName()));
								});
							}
							else {
								e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.RED).setTitle(STATIC.getTranslation(e.getMember(), Translation.EMBED_TITLE_PERMISSIONS)).setDescription(STATIC.getTranslation(e.getMember(), Translation.MISSING_PERMISSION)+Permission.MESSAGE_ADD_REACTION.getName()).build()).queue();
					...
					if(EmojiParser.parseToAliases(e.getEmoji().getName()).equals(":arrow_left:") || EmojiParser.parseToAliases(e.getEmoji().getName()).equals(":arrow_right:")) {
						//inventory reactions
						...
						if(inventory != null && inventory.getExpiration() >= System.currentTimeMillis()) {
							if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_ATTACH_FILES) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_ATTACH_FILES))) {
								...
								if(EmojiParser.parseToAliases(e.getEmoji().getName()).equals(":arrow_left:") && current_page != 1)
									current_page--;
								else if(EmojiParser.parseToAliases(e.getEmoji().getName()).equals(":arrow_right:") && current_page != last_page)
									current_page++;
								if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.MESSAGE_MANAGE) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.MESSAGE_MANAGE))) {
								...
								if(inventory_tab.equalsIgnoreCase("weapons")) {
									if(!sub_tab.equalsIgnoreCase("total"))
										InventoryBuilder.drawInventory(e.getGuild(), e.getMember(), e.getChannel().asTextChannel(), inventory_tab, sub_tab, RankingSystem.SQLgetInventoryAndDescriptionsWeapons(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), ((current_page-1)*maxItems), maxItems, sub_tab), current_page, last_page, guild_settings);
									else
										InventoryBuilder.drawInventory(e.getGuild(), e.getMember(), e.getChannel().asTextChannel(), inventory_tab, sub_tab, RankingSystem.SQLgetInventoryAndDescriptionsWeapons(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), ((current_page-1)*maxItems), maxItems), current_page, last_page, guild_settings);
								}
								else if(inventory_tab.equalsIgnoreCase("skins"))
									InventoryBuilder.drawInventory(e.getGuild(), e.getMember(), e.getChannel().asTextChannel(), inventory_tab, sub_tab, RankingSystem.SQLgetInventoryAndDescriptionsSkins(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), ((current_page-1)*maxItems), maxItems), current_page, last_page, guild_settings);
								else
									InventoryBuilder.drawInventory(e.getGuild(), e.getMember(), e.getChannel().asTextChannel(), inventory_tab, sub_tab, RankingSystem.SQLgetInventoryAndDescriptions(e.getMember().getUser().getIdLong(), e.getGuild().getIdLong(), ((current_page-1)*maxItems), maxItems), current_page, last_page, guild_settings);
							}
							else {
								STATIC.writeToRemoteChannel(e.getGuild(), new EmbedBuilder().setColor(Color.RED).setTitle(STATIC.getTranslation2(e.getGuild(), Translation.EMBED_TITLE_PERMISSIONS)), STATIC.getTranslation2(e.getGuild(), Translation.MISSING_PERMISSION_IN).replace("{}", Permission.MESSAGE_SEND.getName()+", "+Permission.MESSAGE_ATTACH_FILES.getName())+"<#"+e.getChannel().getId()+">", Channel.LOG.getType());
						...
						//execute if it's a randomshop reaction
							...
							if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_ATTACH_FILES) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_ATTACH_FILES))) {
								...
								RandomshopExecution.inspectItems(e.getMember(), e.getChannel().asTextChannel(), RankingSystemItems.SQLgetWeaponAbbvs(e.getGuild().getIdLong()), RankingSystemItems.SQLgetWeaponCategories(e.getGuild().getIdLong(), false), input, current_page, true);
							}
							else {
								STATIC.writeToRemoteChannel(e.getGuild(), new EmbedBuilder().setColor(Color.RED).setTitle(STATIC.getTranslation2(e.getGuild(), Translation.EMBED_TITLE_PERMISSIONS)), STATIC.getTranslation2(e.getGuild(), Translation.MISSING_PERMISSION_IN).replace("{}", Permission.MESSAGE_SEND.getName()+", "+Permission.MESSAGE_ATTACH_FILES.getName())+"<#"+e.getChannel().getId()+">", Channel.LOG.getType());
						...
						//execute if it's a clan reaction
							...
							if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_HISTORY, Permission.MESSAGE_ADD_REACTION) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_HISTORY, Permission.MESSAGE_ADD_REACTION))) {
								...
								if(EmojiParser.parseToAliases(e.getEmoji().getName()).equals(":arrow_left:") && currentPage != 1)
									currentPage--;
								else if(EmojiParser.parseToAliases(e.getEmoji().getName()).equals(":arrow_right:") && currentPage != totPages)
									currentPage++;
								...
								e.getChannel().retrieveMessageById(e.getMessageId()).queue(m -> {
									...
									e.getChannel().sendMessageEmbeds(new EmbedBuilder().setColor(Color.BLUE).setAuthor(STATIC.getTranslation(e.getMember(), Translation.TOP_PAGE)+page+"/"+lastPage).setTitle(STATIC.getTranslation(e.getMember(), Translation.CLAN_TITLE)).setDescription(out.toString()).build()).queue(m2 -> {
										m2.addReaction(Emoji.fromUnicode(EmojiManager.getForAlias(":arrow_left:").getUnicode())).queue();
										m2.addReaction(Emoji.fromUnicode(EmojiManager.getForAlias(":arrow_right:").getUnicode())).queue();
								...
								STATIC.writeToRemoteChannel(e.getGuild(), new EmbedBuilder().setColor(Color.RED).setTitle(STATIC.getTranslation2(e.getGuild(), Translation.EMBED_TITLE_PERMISSIONS)), STATIC.getTranslation2(e.getGuild(), Translation.MISSING_PERMISSION_IN).replace("{}", Permission.MESSAGE_SEND.getName()+", "+Permission.MESSAGE_HISTORY.getName()+", "+Permission.MESSAGE_ADD_REACTION.getName())+"<#"+e.getChannel().getId()+">", Channel.LOG.getType());
						...
						//execute if it's a pagination reaction
							...
							if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_HISTORY, Permission.MESSAGE_MANAGE) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_HISTORY, Permission.MESSAGE_MANAGE))) {
								final int curPage = Integer.parseInt(pagination.getAdditionalInfo());
								if(EmojiParser.parseToAliases(e.getEmoji().getName()).equals(":arrow_left:")) {
									if(curPage == 1) {
										...
										e.getChannel().retrieveMessageById(e.getMessageId()).queue(m -> {
											...
											m.editMessageEmbeds(rebuildEmbed(m.getEmbeds().get(0), out.toString(), curPage-1, maxPage).build()).queue();
											e.getReaction().removeReaction(e.getMember().getUser()).queue();
										});
								...
								STATIC.writeToRemoteChannel(e.getGuild(), new EmbedBuilder().setColor(Color.RED).setTitle(STATIC.getTranslation2(e.getGuild(), Translation.EMBED_TITLE_PERMISSIONS)), STATIC.getTranslation2(e.getGuild(), Translation.MISSING_PERMISSION_IN).replace("{}", Permission.MESSAGE_SEND.getName()+", "+Permission.MESSAGE_HISTORY.getName()+", "+Permission.MESSAGE_MANAGE.getName())+"<#"+e.getChannel().getId()+">", Channel.LOG.getType());
					...
					if(thisChannel != null && thisChannel.getChannel_Type() != null && (thisChannel.getChannel_Type().equals(Channel.VOT.getType()) || thisChannel.getChannel_Type().equals(Channel.VO2.getType()))) {
						if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.VIEW_CHANNEL, Permission.MESSAGE_MANAGE, Permission.MESSAGE_HISTORY) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_MANAGE, Permission.MESSAGE_HISTORY))) {
							BotConfigs botConfig = BotConfiguration.SQLgetBotConfigs(e.getGuild().getIdLong());
							...
							if((e.getEmoji().getType().equals(Emoji.Type.UNICODE) && thumbsup instanceof String && ((String)thumbsup).equals(e.getEmoji().getName())) || (e.getEmoji().getType().equals(Emoji.Type.CUSTOM) && thumbsup instanceof RichCustomEmoji && ((RichCustomEmoji)thumbsup).getIdLong() == e.getEmoji().asCustom().getIdLong())) {
								if(thumbsdown instanceof String)
									e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), Emoji.fromUnicode((String)thumbsdown), e.getUser()).queue();
								else
									e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), (RichCustomEmoji)thumbsdown, e.getUser()).queue();
								if(thisChannel.getChannel_Type().equals(Channel.VO2.getType())) {
									if(shrug instanceof String)
										e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), Emoji.fromUnicode((String)shrug), e.getUser()).queue();
									else
										e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), (RichCustomEmoji)shrug, e.getUser()).queue();
								}
								runSpreadsheet = true;
							}
							else if((e.getEmoji().getType().equals(Emoji.Type.UNICODE) && thumbsdown instanceof String && ((String)thumbsdown).equals(e.getEmoji().getName())) || (e.getEmoji().getType().equals(Emoji.Type.CUSTOM) && thumbsdown instanceof RichCustomEmoji && ((RichCustomEmoji)thumbsdown).getIdLong() == e.getEmoji().asCustom().getIdLong())) {
								if(thumbsup instanceof String)
									e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), Emoji.fromUnicode((String)thumbsup), e.getUser()).queue();
								else
									e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), (RichCustomEmoji)thumbsup, e.getUser()).queue();
								if(thisChannel.getChannel_Type().equals(Channel.VO2.getType())) {
									if(shrug instanceof String)
										e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), Emoji.fromUnicode((String)shrug), e.getUser()).queue();
									else
							...
							else if((e.getEmoji().getType().equals(Emoji.Type.UNICODE) && shrug instanceof String && ((String)shrug).equals(e.getEmoji().getName())) || (e.getEmoji().getType().equals(Emoji.Type.CUSTOM) && shrug instanceof RichCustomEmoji && ((RichCustomEmoji)shrug).getIdLong() == e.getEmoji().asCustom().getIdLong())) {
								if(thumbsdown instanceof String)
									e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), Emoji.fromUnicode((String)thumbsdown), e.getUser()).queue();
								else
									e.getChannel().asTextChannel().removeReactionById(e.getMessageIdLong(), (RichCustomEmoji)thumbsdown, e.getUser()).queue();
	 ...
	 * @param e
	 */
	private static void printPermissionError(MessageReactionAddEvent e) {
	...
	private static void runVoteSpreadsheetService(boolean runSpreadsheet, MessageReactionAddEvent e, BotConfigs botConfig) {
	...
	private static String buildPaginationMessage(Member member, Object item, Object prevItem, String method) {
		...
		//Derived from H!google spreadsheets
		else if(item instanceof GoogleAPISetup)
			return "**"+GoogleUtils.buildFileURL(((GoogleAPISetup)item).getFileID(), 2)+"**";
		return "";
	}
