...
public class GuildMessageEditListener extends ListenerAdapter {
						...
						if(filter_lang != null && filter_lang.size() > 0) {
							if(e.getGuild().getSelfMember().hasPermission(e.getGuildChannel(), Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_MANAGE) || STATIC.setPermissions(e.getGuild(), e.getChannel().asTextChannel(), EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_MANAGE))) {
								...
								if(allChannels.parallelStream().filter(f -> f.getChannel_ID() == channel_id && f.getURLCensoring()).findAny().orElse(null) != null)
									new Thread(new URLFilter(e.getMessage(), e.getMessage().getMember(), allChannels)).start();
							}
							else {
	...
	private static void runVoteSpreadsheetService(MessageUpdateEvent e, ArrayList<Channels> allChannels, BotConfigs botConfig) {
		if(e.isFromGuild() && e.getChannelType().equals(ChannelType.TEXT)) {
							...
							try {
								...
								if(response.getValues() != null && response.getValues().parallelStream().filter(f -> f.parallelStream().filter(f2 -> ((String)f2).equals(e.getMessageId())).findAny().orElse(null) != null).findAny().orElse(null) != null) {
											...
											if(columns != null && columns.size() > 0) {
												...
												if(columnMessage != 0) {
													...
													for(final var reaction : e.getChannel().retrieveMessageById(e.getMessageIdLong()).complete().getReactions()) {
														if(columnUpVote > 0 && ((reaction.getEmoji().getType().equals(Type.UNICODE) && thumbsup instanceof String && reaction.getEmoji().getName().equals((String)thumbsup)) || (reaction.getEmoji().getType().equals(Type.CUSTOM) && thumbsup instanceof RichCustomEmoji && reaction.getEmoji().asCustom().getIdLong() == ((RichCustomEmoji)thumbsup).getIdLong())))
															countThumbsUp = reaction.getCount()-1;
														if(columnDownVote > 0 && ((reaction.getEmoji().getType().equals(Type.UNICODE) && thumbsdown instanceof String && reaction.getEmoji().getName().equals((String)thumbsdown)) || (reaction.getEmoji().getType().equals(Type.CUSTOM) && thumbsdown instanceof RichCustomEmoji && reaction.getEmoji().asCustom().getIdLong() == ((RichCustomEmoji)thumbsdown).getIdLong())))
															countThumbsDown = reaction.getCount()-1;
														if(columnShrugVote > 0 && ((reaction.getEmoji().getType().equals(Type.UNICODE) && shrug instanceof String && reaction.getEmoji().getName().equals((String)shrug)) || (reaction.getEmoji().getType().equals(Type.CUSTOM) && shrug instanceof RichCustomEmoji && reaction.getEmoji().asCustom().getIdLong() == ((RichCustomEmoji)shrug).getIdLong())))
									...
									for(final var reaction : e.getChannel().retrieveMessageById(e.getMessageId()).complete().getReactions()) {
										if(reaction.getEmoji().getType().equals(Emoji.Type.UNICODE) && thumbsup instanceof String && reaction.getEmoji().getName().equals((String)thumbsup))
											upVote = reaction.getCount()-1;
										else if(reaction.getEmoji().getType().equals(Emoji.Type.CUSTOM) && thumbsup instanceof RichCustomEmoji && reaction.getEmoji().asCustom().getIdLong() == ((RichCustomEmoji)thumbsup).getIdLong())
											upVote = reaction.getCount()-1;
										else if(reaction.getEmoji().getType().equals(Emoji.Type.UNICODE) && thumbsdown instanceof String && reaction.getEmoji().getName().equals((String)thumbsdown))
											downVote = reaction.getCount()-1;
										else if(reaction.getEmoji().getType().equals(Emoji.Type.CUSTOM) && thumbsdown instanceof RichCustomEmoji && reaction.getEmoji().asCustom().getIdLong() == ((RichCustomEmoji)thumbsdown).getIdLong())
											downVote = reaction.getCount()-1;
										else if(reaction.getEmoji().getType().equals(Emoji.Type.UNICODE) && shrug instanceof String && reaction.getEmoji().getName().equals((String)shrug))
											shrugVote = reaction.getCount()-1;
										else if(reaction.getEmoji().getType().equals(Emoji.Type.CUSTOM) && shrug instanceof RichCustomEmoji && reaction.getEmoji().asCustom().getIdLong() == ((RichCustomEmoji)shrug).getIdLong())
											shrugVote = reaction.getCount()-1;
									}
	...
	private static void runCommentSpreadsheetService(MessageUpdateEvent e) {
