...
public class HelpText {
	...
	public static String getHelp(){
		...
		if(IniFileReader.getShutDownCommand().equals("true") || IniFileReader.getRebootCommand().equals("true") || IniFileReader.getRegisterCommand().equals("true") || IniFileReader.getSetCommand().equals("true") || IniFileReader.getUserCommand().equals("true") || IniFileReader.getFilterCommand().equals("true") || IniFileReader.getRoleReactionCommand().equals("true")){
			administration = true;
		}
		...
		if(IniFileReader.getRoleReactionCommand().equals("true"))textCollector.add("**-"+IniFileReader.getCommandPrefix()+"roleReaction**\nenable / disable the role reaction and remove roles on disable\n\n");
