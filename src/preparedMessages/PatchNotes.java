...
public class PatchNotes {
	...
	public static String patchNotes(){
		...
		textCollector.add("-New command called "+IniFileReader.getCommandPrefix()+"user added. Display a full information list about a user or directly decide to ban or kick with a reason and more\n");
		...
		textCollector.add("-New command called "+IniFileReader.getCommandPrefix()+"filter added. Display the current filter, add new words or delete them anytime while the bot is running\n");
