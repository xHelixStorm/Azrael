...
--
-- Host: localhost:3306
-- Erstellungszeit: 25. Sep 2018 um 00:08
...
INSERT INTO `guilds` (`guild_id`, `name`, `max_level`, `fk_level_id`, `fk_rank_id`, `fk_profile_id`, `fk_icon_id`, `ranking_state`) VALUES
(300256161603780608, 'Test', 80, 1, 1, 1, 1, 1);
...
INSERT INTO `level_list` (`level`, `experience`) VALUES
(0, 0),
(1, 300),
(2, 600),
(3, 900),
...
INSERT INTO `roles` (`role_id`, `name`, `level_requirement`, `fk_guild_id`) VALUES
(305757212926672896, 'test', 1, 300256161603780608);
...
INSERT INTO `users` (`user_id`, `name`, `level_skin`, `rank_skin`, `profile_skin`, `icon_skin`) VALUES
(178476474431569920, 'Heiliger#7143', 1, 1, 1, 1),
(269789786150010882, 'Verdreaux#1864', 1, 1, 1, 1),
(300257638342590464, 'MyPersonalBot2017#9920', 1, 1, 1, 1),
(467642053434802176, 'Helix test#0350', 1, 1, 1, 1),
(471969455111405569, 'testman#7194', 1, 1, 1, 1),
(480322813954359296, 'helix test2#3440', 1, 1, 1, 1);
...
--
ALTER TABLE `max_exp`
  MODIFY `max_exp_id` int(11) NOT NULL AUTO_INCREMENT;
--
